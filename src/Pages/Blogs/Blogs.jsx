...
const Blogs = () => {
  ...
  <section className="my-32 text-center md:text-left">
    <h2 className="mb-12 text-center text-3xl font-bold text-blue-500">Latest Blogs</h2>
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      ...
      <div>
        <h3 className="mb-3 text-2xl font-bold">Craft Your Tasks</h3>
        ...
        Leverage insightful analytics to track task completion rates, identify trends, and make data-driven decisions.
        </p>
      </div>
    </div>
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      ...
      <div className="md:order-1">
        <h3 className="mb-3 text-2xl font-bold">Crafted Workflows</h3>
        ...
        <p className="text-neutral-500 dark:text-neutral-300">
        Organize tasks seamlessly with customizable status labels: To-Do In Progress and Completed.
Enjoy flexibility with drag-and-drop functionality for effortless task management.
        </p>
      </div>
    </div>
    <div className="mb-12 grid items-center gap-x-6 md:grid-cols-2 xl:gap-x-12">
      ...
      <div>
        <h3 className="mb-3 text-2xl font-bold">Craft Insights</h3>
        ...
        <p className="text-neutral-500 dark:text-neutral-300">
        Easily create and customize tasks with a user-friendly interface.
        </p>
      </div>
    </div>
  </section>
